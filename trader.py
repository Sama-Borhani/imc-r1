...
from params import (
    ...
    PEPPER,
    OSMIUM_FAIR_VALUE,
    PEPPER_BLEND_POPULAR_MID,
    PEPPER_BLEND_TREND,
    PEPPER_INITIAL_INTERCEPT,
    PEPPER_INTERCEPT_WINDOW,
    PRODUCT_CONFIG,
...
class Trader:
    ...
    def make_orders(
        ...
        # 1) Aggressively take stale quotes first.
        ...
        # 2) Then place passive quotes inside the spread when edge remains.
        passive_bid = None
        passive_ask = None
    ...
    def get_popular_mid(order_depth: OrderDepth) -> Optional[float]:
        ...
        popular_ask = min(order_depth.sell_orders.items(), key=lambda kv: -abs(kv[1]))[0]
